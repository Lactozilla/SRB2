...
/** Normalizes a vector. Note that this function tries to normalize correctly
...
/** Normalizes a vector. Does the same as SWRast_NormalizeVec3,
	but with floating point math. Prevents overflows. */
