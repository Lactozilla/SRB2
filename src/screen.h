...
extern void (*colfuncs[NUMCOLUMNFUNCS])(void);
extern void (*colfuncs_rotated[NUMCOLUMNFUNCS])(void);
...
extern void (*spanfuncs[NUMSPANFUNCS])(void);
extern void (*spanfuncs_npo2[NUMSPANFUNCS])(void);
