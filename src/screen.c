...
// --------------------------------------------
void (*colfunc)(void);
void (*colfuncs[NUMCOLUMNFUNCS])(void);
void (*colfuncs_rotated[NUMCOLUMNFUNCS])(void);

void (*spanfunc)(void);
void (*spanfuncs[NUMSPANFUNCS])(void);
void (*spanfuncs_npo2[NUMSPANFUNCS])(void);
...
void SCR_SetDrawFuncs(void)
{
	...
	if (true)//vid.bpp == 1) //Always run in 8bpp. todo: remove all 16bpp code?
	{
		...
		colfuncs[COLUMN_TRANSLUCENT] = R_DrawTranslucentColumn_8;
		colfuncs[COLUMN_TRANSLATED] = R_DrawTranslatedColumn_8;
		colfuncs[COLUMN_SHADE] = R_DrawShadeColumn_8;
		colfuncs[COLUMN_SHADOWED] = R_DrawColumnShadowed_8;
		colfuncs[COLUMN_TRANSTRANS] = R_DrawTranslatedTranslucentColumn_8;
		colfuncs[COLUMN_MULTIPATCH] = R_Draw2sMultiPatchColumn_8;
		colfuncs[COLUMN_MULTIPATCHTRANS] = R_Draw2sMultiPatchTranslucentColumn_8;
		colfuncs[COLUMN_FOG] = R_DrawFogColumn_8;

		// Lactozilla: Rotated sprites
		colfuncs_rotated[BASEDRAWFUNC] = R_DrawRotatedColumn_8;
		colfuncs_rotated[COLUMN_TRANSLUCENT] = R_DrawRotatedTranslucentColumn_8;
		colfuncs_rotated[COLUMN_TRANSLATED] = R_DrawRotatedTranslatedColumn_8;
		colfuncs_rotated[COLUMN_TRANSTRANS] = R_DrawRotatedTranslatedTranslucentColumn_8;

		spanfuncs[SPAN_TRANSLUCENT] = R_DrawTranslucentSpan_8;
		spanfuncs[SPAN_SPLAT] = R_DrawSplat_8;
		spanfuncs[SPAN_TRANSSPLAT] = R_DrawTranslucentSplat_8;
		spanfuncs[SPAN_SPRITE] = R_DrawFloorSprite_8;
		spanfuncs[SPAN_TRANSSPRITE] = R_DrawTranslucentFloorSprite_8;
		spanfuncs[SPAN_TILTEDSPRITE] = R_DrawTiltedFloorSprite_8;
		spanfuncs[SPAN_TILTEDTRANSSPRITE] = R_DrawTiltedTranslucentFloorSprite_8;
		spanfuncs[SPAN_FOG] = R_DrawFogSpan_8;
#ifndef NOWATER
		spanfuncs[SPAN_WATER] = R_DrawTranslucentWaterSpan_8;
#endif
		spanfuncs[SPAN_TILTED] = R_DrawTiltedSpan_8;
		spanfuncs[SPAN_TILTEDTRANS] = R_DrawTiltedTranslucentSpan_8;
#ifndef NOWATER
		spanfuncs[SPAN_TILTEDWATER] = R_DrawTiltedTranslucentWaterSpan_8;
#endif
		spanfuncs[SPAN_TILTEDSPLAT] = R_DrawTiltedSplat_8;

		// Lactozilla: Non-powers-of-two
		spanfuncs_npo2[BASEDRAWFUNC] = R_DrawSpan_NPO2_8;
		spanfuncs_npo2[SPAN_TRANSLUCENT] = R_DrawTranslucentSpan_NPO2_8;
		spanfuncs_npo2[SPAN_SPLAT] = R_DrawSplat_NPO2_8;
		spanfuncs_npo2[SPAN_TRANSSPLAT] = R_DrawTranslucentSplat_NPO2_8;
		spanfuncs_npo2[SPAN_SPRITE] = R_DrawFloorSprite_NPO2_8;
		spanfuncs_npo2[SPAN_TRANSSPRITE] = R_DrawTranslucentFloorSprite_NPO2_8;
		spanfuncs_npo2[SPAN_TILTEDSPRITE] = R_DrawTiltedFloorSprite_NPO2_8;
		spanfuncs_npo2[SPAN_TILTEDTRANSSPRITE] = R_DrawTiltedTranslucentFloorSprite_NPO2_8;
		spanfuncs_npo2[SPAN_FOG] = NULL; // Not needed
#ifndef NOWATER
		spanfuncs_npo2[SPAN_WATER] = R_DrawTranslucentWaterSpan_NPO2_8;
#endif
		spanfuncs_npo2[SPAN_TILTED] = R_DrawTiltedSpan_NPO2_8;
		spanfuncs_npo2[SPAN_TILTEDTRANS] = R_DrawTiltedTranslucentSpan_NPO2_8;
#ifndef NOWATER
		spanfuncs_npo2[SPAN_TILTEDWATER] = R_DrawTiltedTranslucentWaterSpan_NPO2_8;
#endif
		spanfuncs_npo2[SPAN_TILTEDSPLAT] = R_DrawTiltedSplat_NPO2_8;
